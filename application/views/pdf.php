...
$sql    = "SELECT ID, uid, category, brand,Product,Productprice,Manfacturer,SKU,unit_present,Description,ShortDescription,image FROM products WHERE uid = $id";
...
while ($row = mysql_fetch_assoc($result)) {
 ...
 //$tbl .= '<tr><td>'.$pn.'</td><td>'.$brands.'</td><td>'.$manuf.'</td><td>'.$desc.'</td><td>'.$s_desc.'</td><td>'.$price.'</td></tr>'; 
...
/*<div>
	<div style="background-color:#F1F1F1">
		<img style="padding:20px;width:100px;height:100px;float:left;" src="http://storescraft.com/storescraft-backend/productImages/$image"/>
	</div>
	<div style="background-color:#333">
		<h3 style="width:60px;color:#FFF;">Product Name:$pn</h3>
		<h3>Price :$price</h3>
		<h2>Description :</h2>
		<p>$desc</p>
	</div>
